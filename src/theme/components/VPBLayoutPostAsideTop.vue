...
<template>
  <span v-if="postMeta?.category" class="vpb-pill max-w-full rounded-full px-4 py-2">
    <VPBPostCategory :category="postMeta.category" />
  </span>
  <div v-if="postMeta?.tags?.length" class="vpb-soft-panel mt-4 rounded-[1.5rem] p-4">
